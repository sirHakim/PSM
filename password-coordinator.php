...
<div class="topnav">
  ...
  <a class="active" href="password-coordinator.php">Change Password</a>
  <a href="logout.php">Log Out</a>
</div>

                    <div style="height: 200px; background-color: #C0C0C0; padding-top: 10px;">
                    <form action="update-password-coordinator.php" method="post">
